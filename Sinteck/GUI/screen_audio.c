...
void screen_audio(void)
{
	...
	lv_imgbtn_set_src(imgbtn1[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_stereo_am.bin");
	...
	lv_imgbtn_set_src(imgbtn1[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mono_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mpxint_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mpxext_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[2], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mp3_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[3], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mic_am.bin");
...
void screen_audio_1(void)
{
	...
	lv_imgbtn_set_src(imgbtn1[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_75u_am.bin");
	...
	lv_imgbtn_set_src(imgbtn1[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_50u_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_on_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_off_am.bin");
...
void screen_audio_2(void)
{
	...
	lv_imgbtn_set_src(imgbtn1[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_on_am.bin");
	...
	lv_imgbtn_set_src(imgbtn1[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_off_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[0], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mp3Prev_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[1], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mp3Play_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[2], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mp3Next_am.bin");
	...
	lv_imgbtn_set_src(imgbtn2[3], LV_BTN_STATE_TGL_REL, "P:/EX15-XT/img/Btn_mp3Stop_am.bin");
...
#endif
	lv_obj_set_event_cb(imgbtn1, btn_event_esc);
	lv_obj_set_pos(imgbtn1, 142, 2);
}
...
static void btn_stereo(lv_obj_t * btn, lv_event_t event)
{
	if(event == LV_EVENT_RELEASED) {
		...
		//printf("Button Stereo %d Released\n" , id);
		if(id == 0) {
			lv_obj_align(bar[0], NULL, LV_ALIGN_IN_TOP_LEFT, 54, 68);
			Cfg_Stereo = 1;
		}
...
static void btn_emphase(lv_obj_t * btn, lv_event_t event)
{
	if(event == LV_EVENT_RELEASED) {
		uint32_t id = lv_obj_get_user_data(btn);
		//printf("Button Emphase %d Released\n" , id);
		if(id == 0) {
			lv_obj_align(bar[0], NULL, LV_ALIGN_IN_TOP_LEFT, 54, 68);
			Cfg_Emphase = 1;
		}
